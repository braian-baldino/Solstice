...
let CarouselComponentComponent = class CarouselComponentComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let ContactComponentComponent = class ContactComponentComponent {
...
let NavComponentComponent = class NavComponentComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
NavComponentComponent.ctorParameters = () => [
...
let TableComponentComponent = class TableComponentComponent {
    constructor(contactService, router) {
        this.contactService = contactService;
        this.router = router;
    }
