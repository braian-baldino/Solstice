(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ContactComponentComponent = /** @class */ (function () {
                ...
                ContactComponentComponent.prototype.submitContact = function () {
                    var _this = this;
                    if (this.post) {
                        console.log(this.contact);
                        delete this.contact['id'];
                        this.contactService.post(this.contact).subscribe(function (res) { return _this.actionCreated.emit(true); });
                    }
                    else {
                        console.log(this.contact);
                        this.contactService.put(this.contact.id, this.contact).subscribe(function (res) { return _this.actionCreated.emit(true); });
                    }
                };
                ContactComponentComponent.prototype.cancelForm = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TableComponentComponent = /** @class */ (function () {
                ...
                TableComponentComponent.prototype.backToTable = function ($event) {
                    this.tableShow = !$event;
                    this.addShow = $event;
                };
                TableComponentComponent.prototype.updateTable = function ($event) {
                    this.tableShow = $event;
                    this.addShow = !$event;
                    if ($event) {
                        this.getAllContacts();
                ...
                TableComponentComponent.prototype.deleteContact = function (item) {
                    var _this = this;
                    this.contactService.delete(item.id).subscribe(function (res) { return _this.getAllContacts(); });
                };
                TableComponentComponent.prototype.updateContact = function (item) {
                    var _this = this;
                    this.contactService.get(item).subscribe(function (res) {
                        _this.contact = res,
                            _this.action = 'Update',
